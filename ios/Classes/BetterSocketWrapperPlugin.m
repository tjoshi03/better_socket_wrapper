#import "BetterSocketWrapperPlugin.h"
#import "SRWebSocket.h"

@interface BetterSocketWrapperPlugin()<SRWebSocketDelegate,FlutterStreamHandler>
@property (nonatomic,strong) SRWebSocket *webSocket;
@property(nonatomic,strong)FlutterEventSink eventSink;

@end

@implementation BetterSocketWrapperPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FlutterMethodChannel* channel = [FlutterMethodChannel
      methodChannelWithName:@"better_socket_wrapper"
            binaryMessenger:[registrar messenger]];
  BetterSocketWrapperPlugin* instance = [[BetterSocketWrapperPlugin alloc] init];
  [registrar addMethodCallDelegate:instance channel:channel];
      FlutterEventChannel* eventChannel = [FlutterEventChannel eventChannelWithName:@"better_socket_wrapper/event" binaryMessenger:[registrar messenger]];
