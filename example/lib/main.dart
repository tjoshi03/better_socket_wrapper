...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      ...
      //设置监听
      BetterSocketWrapper.addListener(onOpen: (httpStatus, httpStatusMessage) {
      ...
      BetterSocketWrapper.connentSocket("wss://api.matrixone.io/coinsdata/api/MarketsList/", httpHeaders: headers, trustAllHost: true);
